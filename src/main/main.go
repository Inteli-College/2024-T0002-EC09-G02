...
func main() {
	region := os.Args[1]
	Client = Publisher()
	Generator([]SensorStruct{co2Sensor, coSensor, no2Sensor}, "26928", Client, "AirQuality", region)
	Generator([]SensorStruct{pm10_sensor_params, pm25_sensor_params}, "26928", Client, "ParticulateMatter", region)
	Generator([]SensorStruct{solar_sensor_params}, "26928", Client, "Solar", region)
	Generator([]SensorStruct{noise_sensor_params}, "26928", Client, "Noise", region)
}
