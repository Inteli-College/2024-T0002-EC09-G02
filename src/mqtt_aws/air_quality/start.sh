...
python3 aws-iot-device-sdk-python-v2/samples/pubsub.py --config_path "$config_path" --csv_path "$csv_path" --endpoint a1c08ash4mpwrf-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert air_quality_sensor.cert.pem --key air_quality_sensor.private.key --client_id basicPubSub --topic sdk/test/python --count 0